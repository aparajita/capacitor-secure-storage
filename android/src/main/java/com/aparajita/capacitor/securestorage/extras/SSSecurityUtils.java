...
public class SSSecurityUtils implements ISSSecurityUtils  {
  ...
  private void initDecodeCipher(Cipher cipher, String alias) throws SSSecurityException {
    try {
      final KeyStore keyStore = loadKeyStore();
  ...
  @Override
  public String decode(String alias, String encodedString) throws SSSecurityException  {
    try {
      final Cipher cipher = getCipherInstance();
  ...
  @Override
  public boolean isKeystoreContainAlias(String alias) throws SSSecurityException {
    final KeyStore keyStore = loadKeyStore();
    try {
